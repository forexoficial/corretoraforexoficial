...
export function MobileTradingHeader({ selectedAsset }: MobileTradingHeaderProps) {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-sm border-b border-border px-3 py-2.5" style={{ paddingTop: 'calc(env(safe-area-inset-top, 0px) + 0.625rem)' }}>
