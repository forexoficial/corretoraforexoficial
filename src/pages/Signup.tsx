...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-gradient-to-br from-background via-background/95 to-primary/10 relative overflow-hidden">
      ...
      <div className="w-full lg:w-1/3 h-auto lg:h-screen relative z-10 shrink-0 lg:overflow-hidden">
        <img
          src={bannerSignup}
          alt="Signup Banner"
          className="w-full h-auto lg:h-full object-contain lg:object-cover lg:object-center"
        />
